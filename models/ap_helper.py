...
def parse_predictions(end_points, config_dict):
    ...
    pred_corners_3d_upright_camera, pred_box_parameters = predictions2corners3d(
    ...
    if not config_dict['use_3d_nms']:
        ...
        if config_dict['use_iou_for_nms']:
            ...
            if iou_logits.shape[2] > 1:
                iou_logits = torch.gather(iou_logits, 2,
                                          pred_sem_cls.unsqueeze(-1))
...
def parse_groundtruths(end_points, config_dict):
    ...
    gt_corners_3d_upright_camera, _ = groundtruths2corners3d(
        end_points, config_dict)
