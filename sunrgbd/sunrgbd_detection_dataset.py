    ...
    def __init__(self,
        ...
        if use_v1:
            self.data_path = os.path.join(
                BASE_DIR, 'sunrgbd_pc_bbox_votes_50k_v1_%s' % (split_set))
        else:
            self.data_path = os.path.join(
                BASE_DIR, 'sunrgbd_pc_bbox_votes_50k_v2_%s' % (split_set))

        self.raw_data_path = os.path.join(BASE_DIR, 'sunrgbd_trainval')
